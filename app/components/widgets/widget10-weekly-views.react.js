...
var Widget10WeeklyViews = React.createClass({
    ...
    , componentDidMount: function () {
        ...
        nv.addGraph(function() {
                ...
                nv.utils.windowResize(function() {
                    setTimeout(function() {
                        $('.widget-10-chart .nvd3 circle.nv-point').attr("r", "3").css({
                            'stroke-width': '2px',
                            ' stroke-opacity': 0.4
                        });
                    }, 500);
    ...
    , render: function() {
        ...
        return (
                <div className="">
                    {/* START WIDGET */}
                    <div className="widget-10 panel no-border bg-success no-margin widget-loader-bar">
                        <div className="container-xs-height full-height">
                                ...
                                <div className="col-xs-height col-top">
                                    <div className="panel-heading top-left top-right">
                                        <div className="panel-title text-black hint-text">
                                            <span className="font-montserrat fs-11 all-caps">Numar Angajati <i className="fa fa-chevron-right"></i>
                                            </span>
                                        </div>
                            ...
                            <div className="row-xs-height ">
                                <div className="col-xs-height col-top relative">
                                    ...
                                    <div className='widget-10-chart line-chart' data-line-color="black" data-points="true" data-point-color="primary" data-stroke-width="2">
                                        <svg></svg>
                                    </div>
                                </div>
                            </div>
...
module.exports = Widget10WeeklyViews;
