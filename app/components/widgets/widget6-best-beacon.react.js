...
var Widget6BestBeacon = React.createClass({
    ...
    , render: function() {
        ...
        return (
                <div className="ar-1-1">
                    {/* START WIDGET */}
                    <div className="widget-6 panel no-border bg-primary widget widget-loader-circle-lg no-margin" style={styles}>
                        ...
                        <div className="panel-body">
                            <div className="pull-bottom bottom-left bottom-right padding-25">
                                <span className="label font-montserrat fs-11"> Best Beacon</span>
                                <br />
...
module.exports = Widget6BestBeacon;
